...
function abs(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('math::abs', args, _.spec, [
    {args: [{typeId: "d74ad862-e09b-11ed-90f5-c5700db7a94f", optional: false, setoftype: false, variadic: false}], returnTypeId: "d74ad862-e09b-11ed-90f5-c5700db7a94f"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
type var_de7e53e8e09b11ed92f511523ddf54b3λFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
> = $.$expr_Function<
  _std.$number, $.cardutil.overrideLowerBound<$.Cardinality.One, 'Zero'>
>;
type var_de7e53e8e09b11ed92f511523ddf54b3λFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$decimalλICastableTo>>,
> = $.$expr_Function<
 ...
 */
function var_de7e53e8e09b11ed92f511523ddf54b3<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
>(
  vals: P1,
): var_de7e53e8e09b11ed92f511523ddf54b3λFuncExpr<P1>;
/**
 * Return the sample variance of the input set.
 */
function var_de7e53e8e09b11ed92f511523ddf54b3<
...
>(
  vals: P1,
): var_de7e53e8e09b11ed92f511523ddf54b3λFuncExpr2<P1>;
function var_de7e53e8e09b11ed92f511523ddf54b3(...args: any[]) {
...
type __defaultExports = {
  ...
  "var": typeof var_de7e53e8e09b11ed92f511523ddf54b3;
...
const __defaultExports: __defaultExports = {
  ...
  "var": var_de7e53e8e09b11ed92f511523ddf54b3,
  "var_pop": var_pop
};

...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(_.spec, "1fd936ec-b413-11ed-960e-c15f44cb5808", _.syntax.literal);
...
const ConnectionTransport: $ConnectionTransport = $.makeType<$ConnectionTransport>(_.spec, "1fd9936c-b413-11ed-abef-01655181ec17", _.syntax.literal);
...
const $ConfigObject = $.makeType<$ConfigObject>(_.spec, "1fd9f348-b413-11ed-8358-29d6f0278a39", _.syntax.literal);
...
const $AbstractConfig = $.makeType<$AbstractConfig>(_.spec, "2008948c-b413-11ed-82a0-950aba2d3c56", _.syntax.literal);
...
const $Auth = $.makeType<$Auth>(_.spec, "1ffbc324-b413-11ed-bd04-7d8694d31ca4", _.syntax.literal);
...
const $AuthMethod = $.makeType<$AuthMethod>(_.spec, "1fdff2de-b413-11ed-b498-afecefe7e4f8", _.syntax.literal);
...
const $Config = $.makeType<$Config>(_.spec, "2020d448-b413-11ed-b0a0-e965a0c51e83", _.syntax.literal);
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(_.spec, "2054b812-b413-11ed-8dc2-e19c0cc67a9b", _.syntax.literal);
...
const $InstanceConfig = $.makeType<$InstanceConfig>(_.spec, "203a9996-b413-11ed-bc69-9ddb7bd58450", _.syntax.literal);
...
const $JWT = $.makeType<$JWT>(_.spec, "1ff44bb2-b413-11ed-bb8c-97117b7e0548", _.syntax.literal);
...
const $SCRAM = $.makeType<$SCRAM>(_.spec, "1fed1cac-b413-11ed-a939-57aebde61d9d", _.syntax.literal);
...
const $Trust = $.makeType<$Trust>(_.spec, "1fe672a8-b413-11ed-9375-951ed51f4766", _.syntax.literal);

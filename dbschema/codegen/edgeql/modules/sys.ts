...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(_.spec, "de864260-e09b-11ed-a3f3-4d17f0484ce9", _.syntax.literal);
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(_.spec, "de86a03e-e09b-11ed-873c-a1244b274334", _.syntax.literal);
...
const $SystemObject = $.makeType<$SystemObject>(_.spec, "de86fd7c-e09b-11ed-81be-a58aac3bb3c5", _.syntax.literal);
...
const $Database = $.makeType<$Database>(_.spec, "de97661c-e09b-11ed-8beb-9fcca82cc6c6", _.syntax.literal);
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(_.spec, "dea9d888-e09b-11ed-a606-c51061d96c9f", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "debf06ea-e09b-11ed-a19f-b9aacac1177e", _.syntax.literal);
...
function get_version(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_version', args, _.spec, [
    {args: [], returnTypeId: "4bd00a2e-0b73-dea5-d6a2-3c53100ced20"},
  ]);
...
function get_transaction_isolation(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_transaction_isolation', args, _.spec, [
    {args: [], returnTypeId: "de864260-e09b-11ed-a3f3-4d17f0484ce9"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,

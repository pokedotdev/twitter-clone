...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(_.spec, "03b58e3a-eb7b-11ed-9028-2be61b0efc15", _.syntax.literal);
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(_.spec, "03b5f2bc-eb7b-11ed-bab5-65b669c4a8eb", _.syntax.literal);

export type $SystemObjectλShape = $.typeutil.flatten<_schema.$Object_ff875e2eeb7a11edb2a74d963d679633λShape & {
}>;
type $SystemObject = $.ObjectType<"sys::SystemObject", $SystemObjectλShape, null, [
  ..._schema.$Object_ff875e2eeb7a11edb2a74d963d679633['__exclusives__'],
]>;
const $SystemObject = $.makeType<$SystemObject>(_.spec, "03b656f8-eb7b-11ed-8451-1592931cd17e", _.syntax.literal);
...
const $ExternalObject = $.makeType<$ExternalObject>(_.spec, "03c0a234-eb7b-11ed-b1a5-dfdf5455cbe3", _.syntax.literal);
...
const $Database = $.makeType<$Database>(_.spec, "03caf112-eb7b-11ed-8449-5b3eaa022dfd", _.syntax.literal);
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(_.spec, "03dd7a12-eb7b-11ed-905d-496c7a0717e6", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "03f368ea-eb7b-11ed-82a3-a7354804fa2d", _.syntax.literal);
...
function get_version(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_version', args, _.spec, [
    {args: [], returnTypeId: "03e04710-eb7b-11ed-91a2-bda6a089c78b"},
  ]);
...
function get_transaction_isolation(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_transaction_isolation', args, _.spec, [
    {args: [], returnTypeId: "03b58e3a-eb7b-11ed-9028-2be61b0efc15"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,

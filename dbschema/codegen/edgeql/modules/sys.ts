...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(_.spec, "27773155-4cfa-11ee-8fd4-f10a9972e855", _.syntax.literal);
...
const VersionStage: $VersionStage = $.makeType<$VersionStage>(_.spec, "2777d3f5-4cfa-11ee-aa52-335a16531b07", _.syntax.literal);

export type $SystemObjectλShape = $.typeutil.flatten<_schema.$Object_20c2d94f4cfa11eeb1eeed90cfdcf1a5λShape & {
}>;
type $SystemObject = $.ObjectType<"sys::SystemObject", $SystemObjectλShape, null, [
  ..._schema.$Object_20c2d94f4cfa11eeb1eeed90cfdcf1a5['__exclusives__'],
]>;
const $SystemObject = $.makeType<$SystemObject>(_.spec, "277874d2-4cfa-11ee-92e0-31a89dd8829a", _.syntax.literal);
...
const $ExternalObject = $.makeType<$ExternalObject>(_.spec, "27864ac2-4cfa-11ee-8487-298bbd0bf7ba", _.syntax.literal);
...
const $Database = $.makeType<$Database>(_.spec, "27941897-4cfa-11ee-817a-396f01202d32", _.syntax.literal);
...
const $ExtensionPackage = $.makeType<$ExtensionPackage>(_.spec, "27aedb36-4cfa-11ee-8163-05948fea0f36", _.syntax.literal);
...
const $Role = $.makeType<$Role>(_.spec, "27cf30fa-4cfa-11ee-a836-713b19471543", _.syntax.literal);
...
function get_version(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_version', args, _.spec, [
    {args: [], returnTypeId: "27b39b84-4cfa-11ee-a168-45820fe50916"},
  ]);
...
function get_transaction_isolation(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::get_transaction_isolation', args, _.spec, [
    {args: [], returnTypeId: "27773155-4cfa-11ee-8fd4-f10a9972e855"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,

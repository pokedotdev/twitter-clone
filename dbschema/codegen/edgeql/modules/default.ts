...
export type $PostλShape = $.typeutil.flatten<_has.$CreatedAtλShape & {
  ...
  "p": $.LinkDesc<$Post, $.Cardinality.AtMostOne, {}, false, true,  false, false>;
  ...
  "<p[is Post]": $.LinkDesc<$Post, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<p": $.LinkDesc<$.ObjectType, $.Cardinality.Many, {}, false, false,  false, false>;
...
const $Post = $.makeType<$Post>(_.spec, "71f69714-57b3-11ee-817f-11ea8db01a7d", _.syntax.literal);
...
const $PostLike = $.makeType<$PostLike>(_.spec, "7d48fd3e-57b3-11ee-9716-65fcce318621", _.syntax.literal);
...
const $User = $.makeType<$User>(_.spec, "70048559-57b3-11ee-8c9b-fbf8a1d8c130", _.syntax.literal);

...
const Object_1eda6830150611ed8c8fb5fe6745a9ba: $.$expr_PathNode<$.TypeSet<$Object_1eda6830150611ed8c8fb5fe6745a9ba, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Object_1eda6830150611ed8c8fb5fe6745a9ba, $.Cardinality.Many), null);
...
export { JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_1eda6830150611ed8c8fb5fe6745a9ba, Object_1eda6830150611ed8c8fb5fe6745a9ba, $FreeObject, FreeObject };

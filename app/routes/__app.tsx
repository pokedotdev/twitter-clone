...
import { ButtonProvider, FormAuth, NavList } from '~/components'
		...
		<>
			<div className="flex justify-center">
				<div className="mdl:grid-cols-[auto_600px_minmax(auto,390px)] inline-grid grid-cols-[auto_minmax(auto,600px)]">
					{/* Header */}
					<div className="sticky top-0 z-10 col-start-1 row-start-1 flex h-16 flex-col justify-center px-0 sm:h-screen sm:items-center sm:px-[5px] md:px-3.5 xl:w-[275px]">
						{/* Logo */}
